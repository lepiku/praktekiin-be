...
class Pasien(models.Model):
    ...
    nama_kk = models.CharField("Nama Kepala Keluarga", max_length=256, blank=True)
    ...
    alamat_kel_desa = models.CharField("Kelurahan / Desa", max_length=32, blank=True)
    alamat_kecamatan = models.CharField(max_length=32, blank=True)
    alamat_kota_kab = models.CharField("Kota / Kabupaten", max_length=32, blank=True)
    ...
    agama = models.CharField(
        max_length=16, blank=True, choices=Agama.choices, default=Agama.KOSONG
    )
...
class RekamMedis(models.Model):
    perjanjian = models.OneToOneField(Perjanjian, null=True, on_delete=models.SET_NULL)
...
class PlanTindakan(models.Model):
    ...
    tindakan = models.ForeignKey(
        "Tindakan", related_name="daftar_plan_tindakan", on_delete=models.CASCADE
    )
    regio = models.PositiveSmallIntegerField()
    gigi = models.PositiveSmallIntegerField()
...
class Pembayaran(models.Model):
    ...
    rekam_medis = models.OneToOneField(RekamMedis, null=True, on_delete=models.SET_NULL)
...
class PembayaranBagiHasil(models.Model):
    ...
    plan_tindakan = models.OneToOneField(PlanTindakan, on_delete=models.CASCADE)
    bagi_hasil = models.PositiveSmallIntegerField()
